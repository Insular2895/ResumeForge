...
function C(e) {
	let t = e.text || "", n = ee.find((e) => t.startsWith(e));
	if (n) {
		let e = t.slice(n.length).trimStart();
		return `<strong>${S(n)}</strong>${e ? ` ${S(e)}` : ""}`;
	}
	return e.strong ? `<strong>${S(t)}</strong>` : S(t);
}
function te(e) {
	let t = e.image_html ? [e.image_html] : [];
	for (let n of e.blocks) n.tag === "h2" ? t.push(`<h2>${S(n.text)}</h2>`) : n.tag === "li" ? t.push(`<ul><li>${S(n.text)}</li></ul>`) : t.push(`<p>${C(n)}</p>`);
	return t.join("\n") || "<p>Document vide.</p>";
}
function ne(e) {
	return {
		image_html: e.image_html || "",
...
function ie({ title: e, document: t, onBlockChange: n }) {
	return /* @__PURE__ */ (0, x.jsxs)("aside", {
		...
		"aria-label": `Édition structurée ${e}`,
		children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("h2", { children: e }), /* @__PURE__ */ (0, x.jsx)("p", { children: "Modifie le texte uniquement. Le design, la photo, les marges et l’ordre du CV restent verrouillés." })] }), /* @__PURE__ */ (0, x.jsx)("div", {
			className: "section-editor-fields",
			children: t.blocks.map((e, t) => /* @__PURE__ */ (0, x.jsxs)("label", {
				className: e.tag === "h2" ? "section-editor-heading-field" : void 0,
				children: [/* @__PURE__ */ (0, x.jsx)("span", { children: e.tag === "h2" ? "Titre de section" : e.tag === "li" ? "Puces" : `Ligne ${t + 1}` }), /* @__PURE__ */ (0, x.jsx)("textarea", {
					value: e.text,
					rows: e.tag === "li" ? 3 : 2,
...
function ae({ title: e, generated: t, initialDocument: n, onChange: r }) {
	let [i, a] = (0, y.useState)(() => ne(n)), o = (0, y.useMemo)(() => te(i), [i]);
	return /* @__PURE__ */ (0, x.jsxs)("div", {
		className: "document-editor-panel structured-document-editor",
		children: [/* @__PURE__ */ (0, x.jsx)(w, { html: o }), /* @__PURE__ */ (0, x.jsx)(ie, {
			title: e,
			document: i,
			onBlockChange: (e, n) => {
				a((i) => {
...
function oe({ session: e }) {
	let [t, n] = (0, y.useState)("cv"), [r] = (0, y.useState)(e.cv_generated), [i, a] = (0, y.useState)(e.cv_edited || e.cv_generated), [o, s] = (0, y.useState)(e.cv_is_dirty), [c] = (0, y.useState)(e.lm_generated), [l, u] = (0, y.useState)(e.lm_edited || e.lm_generated), [d, f] = (0, y.useState)(e.lm_is_dirty);
...
var se = document.getElementById("document-editor-root");
se && (0, b.createRoot)(se).render(/* @__PURE__ */ (0, x.jsx)(oe, { session: re() }));
//#endregion
